            ...
            <div className="container">
                <div className="vision-grid">
                    ...
                    <div className="vision-content">
                        ...
                        <p>
                            Nous combinons une approche globale et personnalisée, avec un accompagnement ponctuel ou continu, pour vous aider à prendre les meilleures décisions dans chaque étape de votre vie. Fondée par trois spécialistes de la finance islamique et de la gestion de patrimoine, Amana combine expertise financière et approche éthique pour protéger et valoriser votre patrimoine.
                        </p>
                    </div>
                </div>
            </div>
