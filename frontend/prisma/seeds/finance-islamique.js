...
module.exports = async function seedFinanceIslamique(prisma) {
  await createPage(prisma, 'finance-islamique', {
    ...
    { type: 'faq', content: { items: [
      ...
      { question: 'Qu\'est-ce que le Nisab et à quoi sert-il ?', answer: 'Le Nisab est le seuil minimum de richesse au-delà duquel la Zakat devient obligatoire. Il est calculé en équivalent or (85g d\'or ≈ 7 395 € en 2025) ou argent (595g d\'argent). Si votre patrimoine zakatable dépasse ce seuil depuis un an lunaire complet (Hawl), vous devez verser 2,5% de ce patrimoine en Zakat.' },
