...
module.exports = async function seedRetraite(prisma) {
  await createPage(prisma, 'retraite', {
    ...
    { type: 'faq', content: { items: [
      ...
      { question: 'L\'avantage fiscal du PER est-il immédiat ?', answer: 'Oui, absolument. Les versements effectués cette année sont déductibles de vos revenus imposables l\'année suivante. Si vous versez 10 000 € et que vous êtes dans la tranche à 30%, vous économisez 3 000 € d\'impôt dès l\'année suivante.' },
    ] } },
