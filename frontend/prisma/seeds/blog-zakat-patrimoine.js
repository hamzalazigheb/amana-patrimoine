  ...
  await createPage(prisma, 'blog/zakat-patrimoine-diversifie', {
    ...
    { type: 'content', content: {
      ...
      steps: [
        ...
        { title: 'Étape 3 : Vérifier le Nisab', description: 'Le Nisab en or 2025 ≈ 7 395 € (85g × 87 €/g). L\'assiette zakatable de Yassine (88 950 €) dépasse largement le Nisab. La Zakat est donc due.' },
